        ...
        <div className="flex items-center justify-around  gap-3 w-full">
          ...
          <div className="flex items-center gap-6 ml-6">
            ...
            <button 
              ...
              className="flex items-center space-x-2 px-2 py-1 border border-gray-300 rounded-md text-sm hover:bg-gray-50 transition-colors"
            >
              ...
              <span className="text-gray-700">{language === 'bn' ? 'বাং' : 'ENG'}</span>
            </button>
