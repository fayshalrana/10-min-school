  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        {/* Chat Button */}
        <button 
           className="w-[50px] h-[46px] bg-gradient-to-r from-green-600 to-green-500 rounded-full shadow-lg hover:bg-green-700 transition-colors flex items-center justify-center"
          onClick={() => window.open('https://api.whatsapp.com/send?phone=+8801896016252&text=I%20need%20your%20assistance', '_blank')}
          title="Chat with us"
        >
         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M0 10.015C0 4.74712 4.21 0 10.02 0C15.7 0 20 4.65699 20 9.98498C20 16.1642 14.96 20 10 20C8.36 20 6.54 19.5593 5.08 18.698C4.57 18.3876 4.14 18.1572 3.59 18.3375L1.57 18.9384C1.06 19.0986 0.6 18.698 0.75 18.1572L1.42 15.9139C1.53 15.6034 1.51 15.2729 1.35 15.0125C0.49 13.4301 0 11.6975 0 10.015ZM5.37004 11.3068C4.67004 11.3068 4.09004 10.7259 4.09004 10.0249C4.09004 9.31382 4.66004 8.74297 5.37004 8.74297C6.08004 8.74297 6.65004 9.31382 6.65004 10.0249C6.65004 10.7259 6.08004 11.2968 5.37004 11.3068ZM8.70005 10.0151C8.70005 10.7262 9.27005 11.297 9.98005 11.307C10.69 11.307 11.26 10.7262 11.26 10.0251C11.26 9.31405 10.69 8.74319 9.98005 8.74319C9.28005 8.73318 8.70005 9.31405 8.70005 10.0151ZM13.31 10.0258C13.31 10.7268 13.88 11.3077 14.59 11.3077C15.3 11.3077 15.87 10.7268 15.87 10.0258C15.87 9.3147 15.3 8.74385 14.59 8.74385C13.88 8.74385 13.31 9.3147 13.31 10.0258Z" fill="#F9FAFB"></path></svg>
        </button>
